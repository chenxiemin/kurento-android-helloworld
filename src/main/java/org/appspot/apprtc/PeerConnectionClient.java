...
public class PeerConnectionClient {
  ...
  public static class PeerConnectionParameters {
    ...
    public PeerConnectionParameters(
        boolean videoCallEnabled, boolean videoSendEnable, boolean audioSendEnable,
      ...
      this.videoSendEnabled = videoSendEnable;
      this.audioSendEnabled = audioSendEnable;
  ...
  public void createPeerConnectionFactory(
    ...
    audioSendEnabled = peerConnectionParameters.audioSendEnabled;
    videoSendEnabled = peerConnectionParameters.audioSendEnabled;
